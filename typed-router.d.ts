...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/_admin': RouteRecordInfo<'/_admin', '/_admin', Record<never, never>, Record<never, never>>,
    ...
    'home-page': RouteRecordInfo<'home-page', '/home', Record<never, never>, Record<never, never>>,
    '/mypage': RouteRecordInfo<'/mypage', '/mypage', Record<never, never>, Record<never, never>, '/mypage/bookmark' | '/mypage/password' | '/mypage/profile'>,
    '/mypage/bookmark': RouteRecordInfo<'/mypage/bookmark', '/mypage/bookmark', Record<never, never>, Record<never, never>>,
    '/mypage/password': RouteRecordInfo<'/mypage/password', '/mypage/password', Record<never, never>, Record<never, never>>,
