<script setup lang="ts">
  ...
  const handleChangeFile = async (e: Event) => {
    ...
    // e.target.files[0]
    // 실제로 파일 업로드 URL
    const downloadURL = await uploadImage(target.files[0]);
...
<template>
  <div class="flex q-pa-xs">
    ...
    <q-btn
      ...
      :color="editor.isActive('italic') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('strike') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :disabled="!editor.can().chain().focus().toggleStrike().run()"
      :color="editor.isActive('link') ? 'blue' : ''"
    />
    ...
    <q-btn
      ...
      :color="editor.isActive('code') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('codeBlock') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('blockquote') ? 'blue' : ''"
    />
    ...
    <q-btn
      ...
      :color="editor.isActive('heading', { level: 1 }) ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('heading', { level: 2 }) ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('heading', { level: 3 }) ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('bulletList') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
      ...
      :color="editor.isActive('orderedList') ? 'blue' : ''"
    />
    <q-btn
      flat
      dense
